...
function Notifications() {
  ...
  useEffect(() => {
    axios
      .get("/api/admin/getadvertisementlisting")
      .then((response) => {
  ...
  const columns = [
    {
      accessorKey: "ad_title", //simple recommended way to define a column
      header: "Title",
      muiTableHeadCellProps: { sx: { color: "black" } }, //optional custom props
      //Cell: ({ cell }) => <span>{cell.getValue()}</span>, //optional custom cell render
    },
    {
      accessorKey: "ad_url", //simple recommended way to define a column
      header: "URL",
      muiTableHeadCellProps: { sx: { color: "black" } }, //optional custom props
      //Cell: ({ cell }) => <span>{cell.getValue()}</span>, //optional custom cell render
    },
    ...
    {
      accessorKey: "date_to", //simple recommended way to define a column
      header: "Date To",
      muiTableHeadCellProps: { sx: { color: "black" } }, //optional custom props
      //Cell: ({ cell }) => <span>{cell.getValue()}</span>, //optional custom cell render
    },
    ...
    <>
      <div className="flex bg-white shadow">
        <div className="pageHeader p-3">
          <h1 className="text-2xl font-semibold">Advertisement Listing</h1>
          <div className="actions">
            <span onClick={() => setIsEditOpen(true)}>
              <Link
                href={"advertisementform"}
                alt="Add New Advertisement"
